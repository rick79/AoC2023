...
current_x <- 1
current_y <- 1
for(i in 1:nrow(dig_plan)) {
  if(dig_plan[i, 1] == "R") {
    current_x <- current_x + strtoi(dig_plan[i, 2])
  } else if(dig_plan[i, 1] == "L") {
    current_x <- current_x - strtoi(dig_plan[i, 2])
  } else if(dig_plan[i, 1] == "U") {
    current_y <- current_y - strtoi(dig_plan[i, 2])
  } else if(dig_plan[i, 1] == "D") {
    current_y <- current_y + strtoi(dig_plan[i, 2])
  }
...
current_y <- 1
for(i in 1:nrow(dig_plan)) {
  if(dig_plan[i, 1] == 0) { # Right
    current_x <- current_x + strtoi(dig_plan[i, 2])
  } else if(dig_plan[i, 1] == 2) { # Left
    current_x <- current_x - strtoi(dig_plan[i, 2])
  } else if(dig_plan[i, 1] == 3) { # Up
    current_y <- current_y - strtoi(dig_plan[i, 2])
  } else if(dig_plan[i, 1] == 1) { # Down
    current_y <- current_y + strtoi(dig_plan[i, 2])
  }
  vertices <- append(vertices, list(c(current_x, current_y))  )
}
